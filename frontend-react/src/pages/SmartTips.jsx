...
const TIPS = [
  // Composting
  { id:1, cat:'Composting', title:'Start a Home Compost Bin', body:'Use a simple plastic bin or clay pot to compost vegetable peels, fruit scraps, and coffee grounds. In 6–8 weeks you get rich fertilizer for your plants — completely free.', img:'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=600&q=80', color:'#10b981' },
  ...
  { id:5, cat:'Composting', title:'Banana Peels for Potassium', body:'Banana peels decompose quickly and release potassium, which strengthens plant roots. Bury them directly in soil or add to compost — roses especially love them.', img:'https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?w=600&q=80', color:'#10b981' },

  // Plastic Reduction
  { id:6, cat:'Plastic Reduction', title:'Carry a Reusable Bag Always', body:'Keep a cloth bag folded in your pocket or purse. One reusable bag replaces 500+ plastic bags over its lifetime. In Karnataka, plastic bags under 75 microns are banned — be ahead of the law.', img:'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=600&q=80', color:'#3b82f6' },
  { id:7, cat:'Plastic Reduction', title:'Switch to a Steel Water Bottle', body:'A single stainless steel bottle replaces 156 plastic bottles per year. It keeps water cold for 24 hours and hot for 12 — and pays for itself in 2 months.', img:'https://images.unsplash.com/photo-1602143407151-7111542de6e8?w=600&q=80', color:'#3b82f6' },
  ...
  { id:9, cat:'Plastic Reduction', title:'Buy in Bulk to Reduce Packaging', body:'Buying larger quantities means less packaging per unit. Bring your own containers to local stores for grains, pulses, and spices — many shops in Karnataka welcome this.', img:'https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=600&q=80', color:'#3b82f6' },
  ...
  { id:13, cat:'Recycling', title:'Flatten Cardboard Boxes', body:'Flatten all cardboard before putting it in the dry bin or giving to kabadiwala. Flat boxes take up less space and fetch better prices — up to Rs 12/kg in Bengaluru.', img:'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=600&q=80', color:'#6366f1' },
  { id:14, cat:'Recycling', title:'Know Your Plastic Numbers', body:'Check the triangle number on plastic items. 1 (PET) and 2 (HDPE) are widely recycled. 3, 6, and 7 are harder to recycle. Avoid 6 (styrofoam) entirely — it never gets recycled.', img:'https://images.unsplash.com/photo-1604187351574-c75ca79f5807?w=600&q=80', color:'#6366f1' },
  { id:15, cat:'Recycling', title:'Sell Metal Scrap for Cash', body:'Aluminium cans fetch Rs 80–120/kg, copper wire Rs 400–500/kg, and steel Rs 20–30/kg at your local kabadiwala. Collect and sell monthly for a small but consistent income.', img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80', color:'#6366f1' },
  ...
  // E-Waste
  { id:18, cat:'E-Waste', title:'Never Throw Batteries in Bins', body:'Batteries contain lead, mercury, and cadmium that leach into soil and groundwater. Drop them at designated e-waste collection points — most electronics stores and malls in Bengaluru have them.', img:'https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?w=600&q=80', color:'#ef4444' },
  { id:19, cat:'E-Waste', title:'Old Phones Have Value', body:'A used smartphone contains gold, silver, copper, and rare earth metals worth Rs 200–2000. Give old phones to certified e-waste recyclers like Attero or E-Parisaraa in Bengaluru rather than throwing them away.', img:'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=600&q=80', color:'#ef4444' },
  ...
  { id:26, cat:'Kitchen & Food', title:'Store Food Properly to Last Longer', body:'Herbs stay fresh for 2 weeks when stored upright in a glass of water like flowers. Wrap leafy greens in a damp cloth. Store onions and potatoes separately — together they spoil faster.', img:'https://images.unsplash.com/photo-1584568694244-14fbdf83bd30?w=600&q=80', color:'#f59e0b' },
  ...
  { id:31, cat:'DIY & Upcycling', title:'Old T-Shirts as Cleaning Rags', body:'Cut worn-out cotton t-shirts into squares for cleaning rags. Cotton is highly absorbent and washable. This replaces paper towels and synthetic cleaning cloths — saving money and waste.', img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80', color:'#8b5cf6' },
  { id:32, cat:'DIY & Upcycling', title:'Newspaper Gift Wrapping', body:'Japanese furoshiki-style wrapping with newspaper or old magazines is beautiful and zero-waste. Add a dried flower or leaf for decoration. The recipient gets two gifts — the present and the wrapping.', img:'https://images.unsplash.com/photo-1512909006721-3d6018887383?w=600&q=80', color:'#8b5cf6' },
  ...
  { id:40, cat:'Water & Energy', title:'Air Dry Clothes When Possible', body:'A clothes dryer uses more electricity than any other home appliance. Air drying on a line or rack is free, gentler on fabrics, and produces zero emissions. In Karnataka\'s climate, clothes dry in 2–4 hours.', img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80', color:'#06b6d4' },

  // Hazardous Waste
  { id:41, cat:'Hazardous Waste', title:'Dispose Medicines Safely', body:'Never flush medicines down the toilet or throw in regular bins. Expired medicines contaminate water supplies. Return them to pharmacies — many in Karnataka accept unused medicines for safe disposal.', img:'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=600&q=80', color:'#ef4444' },
  ...
  { id:43, cat:'Hazardous Waste', title:'Sanitary Waste Needs Special Care', body:'Wrap used sanitary products in newspaper or the wrapper they came in before disposing in the red/hazardous bin. Never flush them — they block sewage systems and take 500+ years to decompose.', img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80', color:'#ef4444' },
  ...
  { id:48, cat:'Community & Habits', title:'Buy Second-Hand First', body:'Before buying anything new, check if a second-hand version exists. Platforms like OLX, Facebook Marketplace, and local thrift stores have furniture, electronics, and clothes at 20–70% less cost — and zero manufacturing waste.', img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80', color:'#10b981' },
  { id:49, cat:'Community & Habits', title:'Repair Before Replacing', body:'India\'s repair culture — cobblers, tailors, electronics repair shops — is a sustainability superpower. A Rs 200 repair extends a product\'s life by years and prevents it from becoming waste.', img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80', color:'#10b981' },
  { id:50, cat:'Community & Habits', title:'Track Your Waste for One Week', body:'For one week, keep a note of everything you throw away. Most people are shocked by how much packaging they discard. Awareness is the first step — once you see it, you start changing it.', img:'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&q=80', color:'#10b981' },
]
...
const BLOGS = [
  ...
  { id:5, cat:'Zero Waste', title:'The Zero Waste Hierarchy: Refuse, Reduce, Reuse, Recycle', date:'Dec 30, 2025', read:'4 min', img:'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=600&q=80', excerpt:'The zero waste movement goes beyond recycling. The most powerful action is at the top of the hierarchy — refusing what you do not need in the first place.' },
  ...
  { id:31, cat:'Health', title:'Burning Waste: Why Open Burning Is a Public Health Crisis', date:'Nov 8, 2025', read:'4 min', img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80', excerpt:'Open burning of waste releases dioxins, furans, and particulate matter that cause cancer, respiratory disease, and developmental disorders. It is illegal — and still widespread.' },
  ...
  { id:35, cat:'Innovation', title:'Biogas from Kitchen Waste: Cooking with Your Own Garbage', date:'Oct 30, 2025', read:'5 min', img:'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=600&q=80', excerpt:'Small-scale biogas digesters can convert a family\'s daily food waste into enough cooking gas for 1–2 hours. Several Karnataka households have installed them with government subsidies.' },
  { id:36, cat:'Carbon Footprint', title:'Your Wardrobe\'s Hidden Environmental Cost', date:'Oct 28, 2025', read:'5 min', img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80', excerpt:'The fashion industry produces 10% of global carbon emissions and is the second largest consumer of water. Fast fashion creates mountains of textile waste — most of it avoidable.' },
  ...
  { id:38, cat:'Karnataka', title:'The Story of Bengaluru\'s Bellandur Lake and Toxic Foam', date:'Oct 24, 2025', read:'6 min', img:'https://images.unsplash.com/photo-1534274988757-a28bf1a57c17?w=600&q=80', excerpt:'Bellandur Lake periodically catches fire and produces toxic foam that spills onto roads. The causes — industrial effluents, sewage, and solid waste — and the long road to restoration.' },
  ...
  return (
    <div className="tips-root">
      ...
      <div className="tips-topbar">
        ...
        <div className="tips-topbar-brand"><RecycleLogo size={22}/><span>{lang === 'kn' ? 'ಸ್ಮಾರ್ಟ್ ಸಲಹೆಗಳು' : 'Smart Tips'}</span></div>
        <span className="tips-count">{filtered.length} {lang === 'kn' ? 'ಸಲಹೆಗಳು' : 'tips'}</span>
      </div>

      {/* Hero */}
      <div className="tips-hero">
        <h1>{lang === 'kn' ? '50 ಸ್ಮಾರ್ಟ್ ತ್ಯಾಜ್ಯ ಸಲಹೆಗಳು' : '50 Smart Waste Tips'}</h1>
        <p>{lang === 'kn' ? 'ಸ್ವಚ್ಛ ಕರ್ನಾಟಕ ಮತ್ತು ಹಸಿರು ಜೀವನಕ್ಕಾಗಿ ಪ್ರಾಯೋಗಿಕ ಸಲಹೆಗಳು' : 'Practical, actionable tips for a cleaner Karnataka and a greener life'}</p>
        <div className="tips-search-wrap">
          ...
          <input
            ...
            placeholder={lang === 'kn' ? 'ಸಲಹೆಗಳು ಹುಡುಕಿ...' : 'Search tips...'}
            value={search}
      ...
      <div className="tips-container">
        {filtered.length === 0 ? (
          <div className="tips-empty">{lang === 'kn' ? `"${search}" ಗೆ ಯಾವುದೇ ಸಲಹೆ ಕಂಡುಬಂದಿಲ್ಲ` : `No tips found for "${search}"`}</div>
        ) : (
              ...
              >
                ...
                <div className="tip-body">
                  ...
                  <button className="tip-toggle" style={{ color: tip.color }}>
                    {expanded === tip.id ? (lang === 'kn' ? 'ಕಡಿಮೆ ತೋರಿಸಿ' : 'Show less') : (lang === 'kn' ? 'ಇನ್ನಷ್ಟು ಓದಿ' : 'Read more')}
      ...
      <div className="blogs-section">
        <div className="blogs-section-hero">
          <h2>{lang === 'kn' ? 'ಇತ್ತೀಚಿನ ಬ್ಲಾಗ್‌ಗಳು' : 'Latest Blogs'}</h2>
          <p>{lang === 'kn' ? 'ತ್ಯಾಜ್ಯ ನಿರ್ವಹಣೆ ಮತ್ತು ಪರಿಸರದ ಬಗ್ಗೆ ಆಳವಾದ ಲೇಖನಗಳು' : 'In-depth articles on waste management, sustainability, and environmental impact'}</p>
          <div className="tips-search-wrap" style={{maxWidth:480,margin:'0 auto'}}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/>
            </svg>
            <input className="tips-search" placeholder={lang === 'kn' ? 'ಬ್ಲಾಗ್ ಹುಡುಕಿ...' : 'Search blogs...'} value={blogSearch} onChange={e => setBlogSearch(e.target.value)}/>
          </div>
        </div>
        ...
        <div className="tips-container">
          {filteredBlogs.length === 0 ? (
            <div className="tips-empty">{lang === 'kn' ? `"${blogSearch}" ಗೆ ಯಾವುದೇ ಬ್ಲಾಗ್ ಕಂಡುಬಂದಿಲ್ಲ` : `No blogs found for "${blogSearch}"`}</div>
          ) : (
              ...
              {filteredBlogs.map(blog => (
                <div key={blog.id} className="blog-card">
                  ...
                  <div className="blog-body">
                    ...
                    <button className="blog-read-btn" onClick={() => setActiveBlog(blog)}>{lang === 'kn' ? 'ಲೇಖನ ಓದಿ' : 'Read Article'}</button>
                  </div>
                </div>
              ))}
            </div>
      ...
      <div className="tips-footer">
        <RecycleLogo size={28}/>
        <p>{lang === 'kn' ? 'Smart Waste — ಒಂದೊಂದು ಸಲಹೆಯಿಂದ ಹಸಿರು ಅಭ್ಯಾಸ ಬೆಳೆಸಿ' : 'Smart Waste — Building greener habits, one tip at a time'}</p>
      </div>
    </div>
  )
}
